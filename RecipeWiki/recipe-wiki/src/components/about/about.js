...
export const About = () => {
  return (
    <div id="about-section">
      ...
      <p>
        RecipeWiki is your go-to resource for culinary creativity, offering a delightful journey through the world of flavors.
        Get ready to embark on a culinary adventure and elevate your cooking game. Happy cooking! 🍽️👨‍🍳🍰
      </p>
    </div>
  );
};
